...
app=FastAPI(title="Trading Forecast",version="12.4")
...
async def asset_forecast(symbol:str):
    ...
    try:
        ...
        return {"ok":True,"שם":get_asset_name(symbol),"סמל":symbol,
                "ימי_היסטוריה":len(daily),"תחזית":f,"זמנים":learn_timing(minute,f.get("כיוון"))}
