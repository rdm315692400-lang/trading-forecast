...
async def history_backfill(
    ...
    """
    Incremental historical cache backfill for the most recent completed period.

    Defaults to 90 calendar days and dry_run=true, so opening the endpoint
    does NOT call Massive unless dry_run=false is explicitly supplied.
    """
